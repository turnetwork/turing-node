...
pub use cli::{error, IntoExit, VersionInfo};
use cli::{informant, parse_and_execute, NoCustom};
use log::info;
use std::ops::Deref;
...
impl ChainSpec {
    pub(crate) fn load(self) -> Result<chain_spec::ChainSpec, String> {
        Ok(match self {
            ...
            ChainSpec::TuringTestnet => chain_spec::turing_testnet_config(),
        })
    }
    ...
    pub(crate) fn from(s: &str) -> Option<Self> {
        match s {
            ...
            "" | "turing" => Some(ChainSpec::TuringTestnet),
            _ => None,
        }
    }
}
